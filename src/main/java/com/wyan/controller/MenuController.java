...
public class MenuController {
	...
	public PageInfo  findPage(int pageNum,int pageSize){
		return menuService.findPage(pageNum, pageSize);
	}
	...
	public PageInfo search(@RequestBody TbMenu menu, int pageNum, int pageSize  ){
		return menuService.findPage(menu, pageNum, pageSize);
	}
