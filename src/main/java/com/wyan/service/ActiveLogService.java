...
public interface ActiveLogService {
	 ...
	 * 增加
	*/
	public void add(TbActiveLog active_log);


	/**
	 * 修改
	 */
	public void update(TbActiveLog active_log);
	 ...
	 * @return
	 */
	public PageInfo findPage(TbActiveLog active_log, int pageNum, int pageSize);
